	...
	game:GetService("RunService").Stepped:Connect(function()
		pcall(function()
			...
			if _G.Settings.Main["Auto Farm Level"] or _G.Settings.Main["Auto New World"] or
				...
				Tushita_Quest2 or Tushita_Quest1AutoFarmMaterial or teleporttop or AutoFarmChest or
				--[For God Human]
...
Page_Configs.Dropdown({
	...
	callback = function(value)
        ...
        spawn(function()
            while task.wait() do
                if FastAttackDelay and FastAttackPc then
                    pcall(function()
...
Page_Configs.Toggle({
	Title = "Fast Attack Pc",
	Default = FastAttackPc,
	callback = function(fastatkfunc)
		FastAttackPc = fastatkfunc
	end,
})
                        ...
                        if SeraphFrame.activeController then
                            if v.Humanoid.Health > 0 then
                              SeraphFrame.activeController.attacking = false
                               ...
                               SeraphFrame.activeController.hitboxMagnitude = 55
